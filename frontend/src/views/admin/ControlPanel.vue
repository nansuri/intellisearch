...
const groups = [
  ...
  { label: 'Statistics', icon: 'stats', items: [{ to: '/admin/stats', label: 'Overview' }, { to: '/admin/stats/visitors', label: 'Unique visitors' }, { to: '/admin/stats/words', label: 'Trending words' }, { to: '/admin/stats/usage', label: 'Per-user usage' }, { to: '/admin/stats/ai', label: 'AI service' }] },
