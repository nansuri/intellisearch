...
func handlerTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&entities.User{}, &entities.AIQueueConfig{}, &entities.UsageLog{}, &entities.ChatSession{}, &entities.Message{}, &entities.SearchResult{}, &entities.AnonymousUsage{}); err != nil {
		t.Fatal(err)
	}
	return db
}
